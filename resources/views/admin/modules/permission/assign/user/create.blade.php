    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-sm-5 col">
                <a href="{{ route('admin.assign.user.index') }}" class="btn btn-secondary float-right mt-2" type="button">
                    Back
                </a>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        @if(session()->has('error'))
                            ...
                            @endphp
                        @endif
                        <form action="{{ route('admin.assign.user.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
