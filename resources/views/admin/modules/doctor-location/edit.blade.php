                                                ...
                                                @else
                                                    @foreach ($days as $index => $day)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control @error('time') is-invalid @enderror" name="time[]" id="time" placeholder="Example : 10:00 AM - 2:00 PM" value="{{ old('time') ?? $day->time }}" style='text-transform:uppercase' autocomplete="off">
                                                                @error('time')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            </td>
